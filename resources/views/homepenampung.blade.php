...
<body class="antialiased">
    <div class="container mx-auto p-6">
        ...
        <div class="flex justify-end mb-4">
            <a href="/" class="bg-purple-400 text-white px-4 py-2 rounded mr-2">DB MIS</a>
            <form action="{{ route('integrate') }}" method="POST">
                @csrf
                <button type="submit" onclick="return confirm('Are you sure you want to integrate data?')"
                    class="bg-cyan-400 text-white px-4 py-2 rounded">Integrate Data</button>
            </form>
        </div>
        {{-- Alert messages --}}
        @if (session('success'))
        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            ...
            <tbody>
                ...
                {{-- If the category change, print the previous sub total --}}
                ...
                <tr class="font-bold bg-gray-400 text-white">
                    <td colspan="2" class="px-4 py-3 border-b text-left">Total</td>
